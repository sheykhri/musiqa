...
class HttpRequest {
    ...
    private function doCurl() {
        ...
        curl_setopt($c, CURLOPT_HTTPHEADER, array("REMOTE_ADDR: $ip", "HTTP_X_FORWARDED_FOR: $ip"));
        ...
        if (empty($this->args['useragent'])) {
            curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Linux; Android 8.1.0; LGM-K120S Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/74.0.3729.157 Mobile Safari/537.36");
        } else {
